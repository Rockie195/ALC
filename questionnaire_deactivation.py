"""
Quick and messy solution to change unneeded questionnaires from active
...
deactivate_applications = [87, 86, 85, 84, 83, 72, 9, 7, 6, 5, 4]
...
def main_app_page():
    ...
    wait(browser, 20).until(EC.visibility_of_element_located(
        (By.CSS_SELECTOR, "#menu-link-CurrMgrApplicationManagerQuestionnaireSearch"))).click()
    wait(browser, 20).until(EC.visibility_of_element_located(
...
try:
    for i in deactivate_applications:
        main_app_page()
        wait(browser, 20).until(EC.visibility_of_element_located(
            (By.XPATH, '/html/body/div[2]/div[4]/div/div/div[1]/div[2]/table/tbody/tr[' + str(i) + ']/td[1]/a'))).click()
        wait(browser, 10).until(EC.element_to_be_clickable(
            (By.XPATH, '/html/body/div[2]/div[4]/div/div/div[1]/form/table[1]/tbody/tr/td[2]/input'))).send_keys(Keys.HOME, "zzz-")
        wait(browser, 20).until(EC.visibility_of_element_located(
            (By.XPATH, '/html/body/div[2]/div[4]/div/div/div[1]/form/table[1]/tbody/tr/td[3]/select'))).click()
        wait(browser, 20).until(EC.visibility_of_element_located(
            (By.XPATH, '/html/body/div[2]/div[4]/div/div/div[1]/form/table[1]/tbody/tr/td[3]/select/option[2]'))).click()
        wait(browser, 20).until(EC.visibility_of_element_located(
